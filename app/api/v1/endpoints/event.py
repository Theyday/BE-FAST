...
def get_event_detail(
    ...
    event = event_service.get_event_detail(event_id, current_user_id)
...
def edit_event(
    ...
    event_service.edit_event(event_id, request, current_user_id)
...
def delete_event(
    ...
    event_service.delete_event(event_id, current_user_id)
