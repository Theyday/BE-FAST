...
def get_task_detail(
    ...
    task = task_service.get_task_detail(task_id, current_user_id)
...
def edit_task(
    ...
    task_service.edit_task(task_id, request, current_user_id)
...
def schedule_task(
    ...
    task_service.schedule_task(task_id, request, current_user_id)
...
def toggle_task_complete(
    ...
    task_service.toggle_task_complete(task_id, date, current_user_id)
